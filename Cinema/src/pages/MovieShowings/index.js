...
export default function MovieShowings() {
    ...
    return (
        <div className={classes.root}>
            ...
            {/* Section phim dành cho bạn */}

            <div className={classes.recommendedSection}>
                <div className={classes.recommendedSectionTitle}>Phim dành cho bạn</div>
                <div className={classes.recommendedContent}>

                    <div className={classes.recommendedRow}>
                        {recommendMovies.map((movie) => (
                            ...
                            >
                                ...
                                <div className={classes.recommendedInfo}>
                                    <div className={classes.recommendedMovieTitle}>{movie.tenPhim}</div>
                                    <div className={classes.recommendedMovieDivider}></div>
                                    <div className={classes.recommendedMovieMeta}>
                                        {movie.thoiLuong}Phút
                                        {movie.ngayKhoiChieu ? ` | ${new Date(movie.ngayKhoiChieu).toLocaleDateString('vi-VN')}` : ''}
                                    </div>
                                </div>
